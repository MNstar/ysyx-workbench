...
#endif
            VL_FATAL_MT("build/Top.sv", 460, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("build/Top.sv", 460, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("build/Top.sv", 460, "", "Active region did not converge.");
            }
